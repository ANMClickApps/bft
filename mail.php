...
$mail->Subject = 'Заявка на получить консультацию';
$mail->Body    = '' .$name . ' оставил заявку, его телефон ' .$phone. '<br>Почта этого пользователя: ' .$email . '<br><br>Текст сообщения:<br>' .$message;
$mail->AltBody = '';
